...
$(function () {
  ...
  async function getCatOne() {
    // 2-1. 请求一级分类列表
    const { list } = await $.get('../php/catOne.php', null, null, 'json')
  ...
  async function getCatTwo() {
    ...
    const { list } = await $.get('../php/catTwo.php', { cat_one: list_info.cat_one }, null, 'json')
  ...
  async function getCatThree() {
    // 6-1. 发送请求
    const { list } = await $.get('../php/catThree.php', { cat_one: list_info.cat_one, cat_two: list_info.cat_two }, null, 'json')
  ...
  async function getCount() {
    // 8-1. 发起请求
    const { count } = await $.get('../php/getCount.php', { cat_one: list_info.cat_one, cat_two: list_info.cat_two, cat_three: list_info.cat_three }, null, 'json')
  ...
  async function getGoodsList() {
    // 9-1. 请求商品列表
    const { list } = await $.get('../php/goodsList.php', list_info, null, 'json')
